...
// console.log("use slice method : ",arr.slice(1,3));//using slice method is , it's doesn't manipulate the real array and it's 
...
const all_Hero2=[...hero_marvel,...DC_Hero]//we can add more arrays.
